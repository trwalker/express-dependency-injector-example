...
var loadRouteConfig = function() {
  ...
  try {
    config = require('./routeconfig.json');
    ...
    throw 'Unable to parse "lib/config/routeconfig.json": ' + e;
  }
...
var loadController = function(routeItem) {
  ...
  if(!routeItem || !routeItem.controller) {
    throw 'Undefined "controller" property in "lib/config/routeconfig.json"';
  }
...
var getRoute = function(routeItem) {
  if(!routeItem || !routeItem.route || routeItem.route.length === 0) {
    throw 'Undefined or empty "route" property in "lib/config/routeconfig.json"';
  }
...
var getMethod = function(routeItem) {
  if(!routeItem || !routeItem.method || routeItem.method.length === 0) {
    throw 'Undefined or empty "method" property in "lib/config/routeconfig.json"';
  }
  ...
  switch(method) {
    ...
    case 'delete':
      ...
      break;
    default:
      throw 'Invalid REST "method" property in "lib/config/routeconfig.json": ' + method;
  }
};
