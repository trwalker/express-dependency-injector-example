...
var loadEnviromentConfigFile = function(os) {
  ...
  var configLocation = './settings.dev.json';

  switch(serverPrefix) {
    case 'm1pw':
    case 'm1sw':
      configLocation = require('./settings.m1.json');
      break;
    case 'p3pw':
    case 'p3ow':
    case 'p3sw':
      configLocation = require('./settings.p3.json');
      break;
    case 'g1tw':
      configLocation = require('./settings.test.json');
      break;
    case 'g1dw':
      configLocation = require('./settings.dev.json');
      break;
  }
